...
app.get('/requestToken', function (req, res) {
  var redirecturl = QuickBooks.AUTHORIZATION_URL +
    ...
    '&redirect_uri=' + encodeURIComponent('https://developer.intuit.com/v2/OAuth2Playground/RedirectUrl') + //encodeURIComponent('http://localhost:' + port + '/callback/') +  // LOCAl Make sure this path matches entry in application dashboard
